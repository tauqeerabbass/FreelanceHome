...
const Header = () => {
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50 w-full h-[110px]">
      <div className="pl-16">
        <div className="flex items-center justify-center h-16">
          ...
          {/* Navigation */}
          <nav className="hidden md:flex items-center space-x-8 w-[677.33px] h-[110px] ml-[70px]">
            <Link
              to="/"
          ...
          <div className="flex items-center space-x-4 w-[379.69px] h-[51px] mt-[39.12px] ml-[150px]">
            <button className="ml-[68px] mt-[0.44px] px-4 py-2 bg-[#3B82F6] text-white h-[51px] w-[114px] rounded-full hover:bg-blue-50 transition-colors font-bold font-inter text-[15px] leading-[21px] tracking-normal">
              Login
            </button>
            ...
            <span className="text-[#161C2D] font-medium font-inter text-[20px] leading-[18px] tracking-normal">
              EN
            </span>
