...
const freelancers = [
  { id: 1, name: "Jacob Jones", title: "IT Specialist in Kaloum" },
  { id: 2, name: "Jacob Jones", title: "SAP Consultant in Kankan" },
  { id: 3, name: "Jacob Jones", title: "SAP Consultant in Kankan" },
  { id: 4, name: "Jacob Jones", title: "SAP Consultant in Kankan" },
  { id: 5, name: "Jacob Jones", title: "SAP Consultant in Kankan" },
  { id: 6, name: "Jacob Jones", title: "SAP Consultant in Kankan" },
]
                ...
                {freelancers.map((freelancer) => (
                  <div key={freelancer.id} className="flex-shrink-0 w-1/5 min-w-[200px]">
                    <div className="bg-white rounded-2xl p-6 text-center text-gray-900">
                      <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gray-200 flex items-center justify-center text-gray-500">
                        User
                      </div>
            ...
            <div key={index} className="bg-slate-700/50 rounded-2xl p-8 border border-slate-600">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <button className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-6 py-2 transition-colors">
                    {service.buttonText} →
                  </button>
                </div>
              </div>
