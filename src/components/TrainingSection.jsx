              ...
              <div className="bg-white rounded-2xl p-6 shadow-2xl max-w-sm">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex -space-x-2">
                    <div className="w-12 h-12 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-gray-500 text-sm">
                      U1
                    </div>
                    <div className="w-12 h-12 rounded-full border-2 border-white bg-yellow-400 flex items-center justify-center">
