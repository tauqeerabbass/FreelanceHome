...
const products = [
  {
    id: 1,
    name: "iPhone 14",
    image: "/placeholder.svg?height=300&width=400&text=iPhone+14",
  ...
  },
  {
    id: 2,
    name: "MacBook Pro M2",
    image: "/placeholder.svg?height=300&width=400&text=MacBook+Pro+M2",
    badges: ["New", "Best Selling"],
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=300&width=400&text=Samsung+Galaxy+S23",
    badges: ["Used"],
