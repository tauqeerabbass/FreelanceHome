  ...
  return (
    <section className="relative bg-gray-900 py-20 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/placeholder.svg?height=800&width=1200&text=Scales+of+Justice+Background')",
        }}
      ></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <Button className="bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-4 rounded-lg text-lg">
              START LEARNING NOW →
            </Button>
          </div>
